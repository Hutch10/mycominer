...
import { KGQuery } from './knowledgeGraphTypes';
...
const initialQuery: KGQuery = {
  scope: 'federated',
  tenantId: 'tenant-alpha',
  federatedTenantIds: ['tenant-beta'],
  nodeTypes: ['workflow', 'sop', 'telemetryStream', 'forecast', 'sandboxScenario', 'plugin', 'digitalTwinSnapshot'],
  maxDepth: 3,
  maxNodes: 80,
};

export default function KnowledgeGraphPage() {
  return <KnowledgeGraphDashboard builderInput={builderInput} initialQuery={initialQuery} />;
}
